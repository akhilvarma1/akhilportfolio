...
<a href="https://www.linkedin.com/in/akhil-varma-6a5a121a6/" className="fa fa-linkedin"></a>
<a href="https://www.youtube.com/" className="fa fa-instagram"></a>
<a href="https://github.com/akhilvarma1" className="fa fa-github"></a>  
    </div>
  </div>
</div>
...
<div id="section2a" className="container-fluid bg-light" style={{paddingTop:'70px',paddingBottom:'70px'}}>
  <h1 className="text-primary" style={{fontFamily: 'Dela Gothic One, cursive',paddingBottom:'40px'}}>Work Experience</h1>
...
<div id="section2" className="container-fluid bg-light" style={{paddingTop:'70px',paddingBottom:'70px'}}>
  ...
  <div className="card bg-primary text-white container crd2">
    <div className="card-body" >
    <h4>MLRITM</h4>
    <p style={{fontFamily: 'Roboto Condensed, sans-serif',fontSize:'25px'}}>Bachelor of Technology<br/> <div style={{fontSize:'19px'}}>Information Technology<br/>2018-2022</div></p>
    <hr style={{backgroundColor:'white'}} />
    <h4>Sri Chaitanya Junior College</h4>
    <p style={{fontFamily: 'Roboto Condensed,sans-serif', fontSize : '25px'}}>Intermediate<br/><div style={{fontSize:'19px'}}>  MPC <br/>Percentage:90.9%</div></p>
    <hr style={{backgroundColor:'white'}} />
    <h4>Dr kkr Gowtham Concept School</h4>
    <p style={{fontFamily: 'Roboto Condensed, sans-serif',fontSize:'25px'}}>High School<br/><div style={{fontSize:'19px'}}> CBSE(Central Board Of Secondary Education)<br/>Percentage:96%</div></p>
